export default function Body() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <div className="bg-gray-50 rounded-md overflow-hidden cursor-pointer">
      ...
      <div className="p-6">
        <div className="mb-6 flex items-center justify-center flex-wrap gap-4">
          <h3 className="text-lg font-bold text-gray-800">Lexicon Luxe</h3>
          <p className="text-lg text-blue-600 font-bold">$10</p>
        </div>
        <button
          type="button"
    ...
    <div className="bg-gray-50 rounded-md overflow-hidden cursor-pointer">
      ...
      <div className="p-6">
        <div className="mb-6 flex items-center justify-center flex-wrap gap-4">
          <h3 className="text-lg font-bold text-gray-800">Adjective Attire</h3>
          <p className="text-lg text-blue-600 font-bold">$12</p>
        </div>
        <button
          type="button"
          className="w-full px-5 py-2.5 bg-blue-600 hover:bg-blue-700 font-bold text-white rounded-lg"
    ...
    <div className="bg-gray-50 rounded-md overflow-hidden cursor-pointer">
      ...
      <div className="p-6">
        <div className="mb-6 flex items-center justify-center flex-wrap gap-4">
          <h3 className="text-lg font-bold text-gray-800">ThreadCraft Vibes</h3>
    ...
    <div className="bg-gray-50 rounded-md overflow-hidden cursor-pointer">
      ...
      <div className="p-6">
        <div className="mb-6 flex items-center justify-center flex-wrap gap-4">
          <h3 className="text-lg font-bold text-gray-800">Verbal Vogue Tees</h3>
          <p className="text-lg text-blue-600 font-bold">$12</p>
        </div>
        <button
          type="button"
