...
export default function Navbar(){
    return(
      <header className="flex bg-white border-b py-4 sm:px-8 px-6 font-[sans-serif] min-h-[80px] tracking-wide">
      <div className="flex flex-wrap items-center lg:gap-y-2 gap-80 w-full">
        ...
        <div className="flex gap-80">
          ...
          <div className="flex border-2 focus-within:border-gray-400 rounded-full px-6 py-3 max-w-52 max-lg:hidden">
            <input
              type="text"
